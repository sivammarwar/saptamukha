...
export async function GET(request) {
  return new Response(JSON.stringify({ 
    status: 'ok', 
    message: 'Face analyze-batch endpoint is running. Use POST for batch analysis requests.',
...
export async function POST(request) {
  try {
    console.log(`[Edge Function] POST /analyze-batch -> ${HF_SPACE_URL}/analyze-batch`);
    ...
    console.log(`[Edge Function] Forwarding to: ${HF_SPACE_URL}/analyze-batch`);
    
    const response = await fetch(`${HF_SPACE_URL}/analyze-batch`, fetchOptions);
